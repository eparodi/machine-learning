...
algorithms = []
# b,c)
# algorithms.append(DecisionTree(used_percentage=0.4, max_nodes=7, inf_gain_function=InfGainFunction.GINI))
# algorithms.append(DecisionTree(used_percentage=0.5, max_nodes=7, inf_gain_function=InfGainFunction.GINI))
# algorithms.append(DecisionTree(used_percentage=0.8, max_nodes=7, inf_gain_function=InfGainFunction.GINI))
...
comparer = Comparer(ds, 0.8, algorithms,rounds=4, test_type=TestType.DISJOINT)
